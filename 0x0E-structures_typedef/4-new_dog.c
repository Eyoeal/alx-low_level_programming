...
/**
 * new_dog - creates a new dog model
 * @name: name member of the dog, passed to new_dog
 * @age: age member of the dog, passed to new_dog
 * @owner: owner member of the dog, passed to new_dog
 *
